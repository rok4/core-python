...
class VectorSet:
    ...
    def from_descriptor(cls, path_descriptor_file: str) -> "VectorSet":
        ...
        except JSONDecodeError as error_loading:
            raise FormatError("JSON", vectorset.__descriptor_object, error_loading)
    ...
    def load_vector_data_content(cls, path: str) -> str:
        ...
        if path.endswith(".geojson") or path.endswith(".gpkg") or path.endswith(".shp"):
            ...
            try:
                ...
                raise RuntimeError(f"Failed to load S3 object: {e}")
        else:
            pass
