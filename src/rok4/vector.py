...
class VectorSet:
    ...
    def from_list(cls, path: str) -> "VectorSet":
        ...
        self.vector_object_dataset = []

        self.path = path

        self.vector_object_dataset.append(Vector.from_file(self.path))
...
class Vector():
    ...
    def from_file(cls, path: str) -> "Vector":
        ...
        self.path_to_data = get_osgeo_path(self.path)
        self.data_content = get_data_str(self.path_to_data)
