...
@patch.object(
    builtins, "open", new_callable=mock_open, read_data="tests/fixtures/TM_WORLD_BORDERS-0.3.shp"
)
...
@patch(
    ...
    return_value=[
        {"path": "valid_path", "tables": "valid_tables"},
    ],
)
...
@patch.object(
    VectorSet, "get_uniq_srs_tables_list", return_value=["EPSG:4326", "EPSG:3857", "EPSG:4559"]
)
